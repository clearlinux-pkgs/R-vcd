...
Version  : 1.4.5
Release  : 24
URL      : https://cran.r-project.org/src/contrib/vcd_1.4-5.tar.gz
Source0  : https://cran.r-project.org/src/contrib/vcd_1.4-5.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1578946830
